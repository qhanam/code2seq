...
var argv = require('yargs')
	...
	.describe('rate', 'The sample rate (number between 0 and 1)')
	.help('h')
	.alias('h', 'help')
	.argv;
...
sample(nominalFilePairs);

/**
 * Randomly sample sequence pairs.
 */
function sample(filePairs) { 
	...
	for(let i = 0; i < filePairs.length; i++) {
		...
		for(let j = 0; j < buggySequences.length; j++) {
			...
			/* Randomly sample sequences according to the sample rate. */
